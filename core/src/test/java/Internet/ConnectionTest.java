...
class ConnectionTest {
    ...
    void returnEmptyListWhenWrongActorUrlsProvided() throws IOException, Config.ArgumentIssue {
        ...
        assertEquals(new ArrayList<>(), connection.createActorsFromFilmwebLinks(emptyList, allActors, null, null));
        assertEquals(new ArrayList<>(), connection.createActorsFromFilmwebLinks(null, allActors, null, null));
        assertEquals(new ArrayList<>(), connection.createActorsFromFilmwebLinks(emptyList, null, null, null));
    }
    ...
    void createFewActorsFromMethod() throws IOException, Config.ArgumentIssue {
        ...
        Connection connection = new Connection(movieUrl);
        List<Actor> createdActors = connection.createActorsFromFilmwebLinks(actorUrls, allActors, null, null);
    ...
    void addCastToMovie() throws IOException, Config.ArgumentIssue {
        ...
        Connection connection = new Connection(movieUrl);
        Movie movie = connection.createMovieFromFilmwebLink();
        connection.addCastToMovie(movie, allActors, null, null);
